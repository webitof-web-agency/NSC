    ...
    return (
        <div className="space-y-4">
            <div className="flex justify-between items-center">
                <h1 className="text-2xl font-bold text-gray-600"> Inventory Report </h1>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <ChartCard title="Total Inventory Value" value={format(chartData?.totalValues || 0)} color="#22c55e" />
                <ChartCard title="Low Stock Items" value={chartData?.lowStockItems || 0} color="#eab308" />
                <ChartCard title="Out of Stock Items" value={chartData?.outOfStockItems || 0} color="#ef4444" />
            </div>
            {/* Filters*/}
            {/* Filters*/}
